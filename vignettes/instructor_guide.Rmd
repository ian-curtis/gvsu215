...
* `plot_bar()`
  ...
  * The `dodge` argument can be used to create more rows on the x-axis labels. This can help if your labels are overlapping. Use an integer to tell how many row to create (more than 2 is not recommened for interpretatiblity).
