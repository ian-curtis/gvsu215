...
Note: Due to the fact that some functions return tables (which are essentially HTML code), the README on GitHub will not display properly. For best results, visit the [online version of the README](https://gvsu215.ianacurtis.com).
